...
<div class="row page-content">
 ...
 <div class="small-2 columns" style="padding-top: 0.5rem;padding-left: 1.625rem;"> <span data-responsive-toggle="sub-responsive-menu" data-hide-for="medium">
    ...
    <div class="small-10 columns nopadding"><h3 class="sub-mobile-menu-header" style="color:#ffffff;">About Section Menu</h3></div>
  </div>
...
echo "<a href='".get_bloginfo('url')."/".get_the_title( $post->post_parent )."'>".get_the_title( $post->post_parent )."</a> >".get_the_title();    
