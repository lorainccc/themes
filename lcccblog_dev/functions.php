...
/* Foundation Init JS */
  ...
  wp_enqueue_style( 'framework-styles', get_template_directory_uri() . '/style.css' );
 
  wp_enqueue_style( 'framework-rtl-styles', get_template_directory_uri() . '/rtl.css' );
...
$defaults = array(
	...
	'default-image' => '%1$s/images/Convocation.png',
	'default-repeat'         => '',
	'default-position-x'     => '',
	'default-attachment'     => '',
...
$chdefaults = array(
	'default-image' => get_stylesheet_directory_uri() . '/images/LCCC-logo.png',
	'width'                  => '',
	'height'                 => '',
	'flex-height'            => false,
	'flex-width'             => false,
...
function themename_customize_register($wp_customize) {
    ...
    $wp_customize->add_section( 'ignite_custom_logo', array(
        ...
        'description'    => 'This is the Custom Header Image to be used for mobile view',
        'priority'       => 40,
    ) );
